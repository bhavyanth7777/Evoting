...
ballotID = [random.randint(2334,2425242524) for i in range(3)] 
encrpytedBallotId = ballotID
region = ['0','0','6']

#----------------VOTERS COLLECTION------------------
for i in range(3):

	voter = {"Name":name[i],"UserName":username[i],"Password":password[i],"EncryptedBallotId":encrpytedBallotId[i],"Region":region[i]}
...
Position = ['President', 'President', 'President', 'President', 'fPresident', 'President', 'Secretary','Secretary','Vice President']
